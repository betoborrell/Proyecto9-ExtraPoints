 ...
 * Users
 *
 * This model represents points in the system
 *
 * @package	none
 * @author	extrapoints
 */
class Puntos extends CI_Model
{
	private $table_name			= 'puntos';			
	...
	/**
	 * Get point record by receiver and class
	 *
	 * @param	int
	 * @param	bool
	 * @return	object
	 */
	function get_points_by_giver($id_receiver)
	{
		$this->db->where('idReceiver', $id_receiver);
